...
SECRET_KEY = 'django-insecure-8ab-g6+mgm__*8igce(^^d^4*_#4v--76p2tj^5)#wrrleti!6'
...
ALLOWED_HOSTS = [
    ...
    "expenseswebsiteapp.onrender.com",
    "127.0.0.1",
    "localhost",
]
...
# static_root = os.path.join(BASE_DIR, 'expenseswebsite/staticfiles')
